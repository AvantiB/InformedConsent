...
3. **Provisional empirical V1 compact/permissive**: data-driven semantic clusters run as-is with cluster-ID field names.
4. **Audited Reduced V1 compact/permissive**: PI/expert-named and organized schema with the same round-trip protocol.
...
→ provisional empirical V1 performance test
...
18_run_reduced_v1_roundtrip.py                  # dynamic compact/permissive V1 validation
